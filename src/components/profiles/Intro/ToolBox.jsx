...
function ToolBox({ same }) {
    ...
    return (
        <ProfileTopToolBox>
            <ProfileShareBtn type="button" onClick={handleShareClick}>
                <ProfileShareSvg width="24" height="24" strokeWidth="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        <g id="style=outline">
                            <path
                                id="Vector (Stroke)"
