...
function AvoidMistakesModal({ setAvoidMistakesModal, setIsExit }) {
    ...
    return (
        <AvoidMistakesModalContainer style={{ overflowY: "auto" }}>
            <AvoidMistakesModalBox tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style={{ width: "20.5rem", display: "flex" }}>
                <AvoidMistakesModalTitleBox>
                    <AvoidMistakesModalTitle id="swal2-title" style={{ display: "block" }}>
                        이 화면에서 나가면
                        <br />
                        작성 중이던 내용이 사라져요.
                ...
                <AvoidMistakesModalBtnBox>
                    <AvoidMistakesModalExitBtn type="button" style={{ display: "inline-block" }} onClick={handleIsExit}>
                        나가기
                    </AvoidMistakesModalExitBtn>
                    <AvoidMistakesModalCancelBtn type="button" style={{ display: "inline-block" }} onClick={handleAvoidMistakesModal}>
                        취소
