...
const QnaActivityToolCommentText = styled.span`
  ...
  font-size: 0.75rem;
`;
function ToolBox({ setLikeUsersModal }) {
  ...
  return (
    <QnaActivitySubContentBox>
      <QnaActivityLikeBtnBox>
        <QnaActivityLikeBtn type="button" onClick={handleModal}>
          <QnaActivityLikeText>
            좋아요 <b>5</b>
          </QnaActivityLikeText>
        </QnaActivityLikeBtn>
      ...
      <QnaActivityToolBox>
        <QnaActivityToolLikeBtn type="button" onClick={handleLike}>
          ...
          <QnaActivityToolLikeText isOn={isLike}>
            좋아요
          </QnaActivityToolLikeText>
        </QnaActivityToolLikeBtn>
        <QnaActivityToolComment to="#">
          ...
          <QnaActivityToolCommentText>댓글 0</QnaActivityToolCommentText>
