            ...
            {createCareer.careerSkills.length === 0 ? (
                <CareerCreateRelativeBox>
                    <CareerCreateButtonBox type="button" onClick={handleCareerSkillModal}>
                        <CareerCreateButtonText>사용한 스킬을 입력해주세요.</CareerCreateButtonText>
                ...
                <CareerSelectedList selectedList={createCareer.careerSkills} handleModal={handleCareerSkillModal} />
            )}
        </CareerInputBox>
    );
};
