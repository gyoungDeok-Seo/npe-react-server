...
import { checkTheComment, insertProfanityApi, replyLikeApi, updateReplyApi } from "../../../service/answerReplyApi";
...
function AnswerReplyComponent({ reply, index, setAnswerList, qnaId }) {
    ...
    const [replyModifyValue, setReplyModifyValue] = useState(reply?.replayContent || "");
    ...
    return (
        <>
                ...
                <AnswerReplyContentBox>
                    {isReplyModify ? (
                        ...
                        <AnswerReplyContentItem>
                            <p style={{ overflowWrap: "anywhere", whiteSpace: "pre-wrap" }}>{reply?.replayContent}</p>
                        </AnswerReplyContentItem>
                    )}
                </AnswerReplyContentBox>
                {!isReplyModify && (
            ...
            {likeModal && <LikeUserModal setLikeUsersModal={setLikeModal} data={reply} />}
            {replyReportModal && <ReportModal setModal={setReplyReportModal} type={type} />}
            {replyDeleteModal && <DeleteModal setModal={setReplyDeleteModal} data={reply} reply={reply} setAnswerList={setAnswerList} qnaId={qnaId} />}
        </>
    );
}
