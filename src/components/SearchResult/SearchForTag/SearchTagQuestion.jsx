    ...
    return (
        <QuestionLink to={""} key={index}>
            <QuestionInfo>
                ...
                <AnswerWrierIntro>
                    <span>{question.writeTime}</span>
                    <span> · </span>
                    <span>
                        {question.writerName} 님의 {question.type === "answer" ? "답변 업데이트" : "새로운 질문"}
                    </span>
                </AnswerWrierIntro>
            </QuestionInfo>
            <QuestionHeaderBox>
                <QuestionHeaderText>신입 개발자 기술 스택 수준</QuestionHeaderText>
            </QuestionHeaderBox>
