            ...
            <SearchTagHeaderItems>
                ...
                <QuestionBox>
                    <div>
                        ...
                        <QuestionCount>49</QuestionCount>
                    </div>
                    <TagSearchIntroBox>
                        <TagSearchIntroSvg width="24" height="24" strokeWidth="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <g id="style=outline">
                        ...
                        <TagSearchIntroItems>
                            ...
                            <TooltipContents>해시태그 없이 키워드만 일치하는 질문은 개수에 포함되지 않아요.</TooltipContents>
                        </TagSearchIntroItems>
                    </TagSearchIntroBox>
                </QuestionBox>
            </SearchTagHeaderItems>
