...
const UpdateQnaTagInner = styled.div`
  display: flex;
  flex-direction: column;
  gap: 0.5rem;
`;
const UpdateQnaTagLabelBox = styled.div`
  display: flex;
  justify-content: space-between;
  align-items: flex-start;
  gap: 1rem;
`;
const UpdateQnaTagLabel = styled.label`
  font-weight: 700;
  font-size: 0.875rem;
  margin-bottom: 0;
`;
const UpdateQnaTagLabelCount = styled.p`
  color: #64748b;
  font-weight: 400;
`;
const UpdateQnaTagInsertBox = styled.div`
  display: flex;
  gap: 0.25rem;
  align-items: center;
  width: 100%;
...
`;
const UpdateQnaTagInsertIcon = styled.span`
  color: #0f172a;
  font-size: 1rem;
`;
const UpdateQnaTagInput = styled.input`
  color: #0f172a;
  padding: 0;
  border-width: 0;
  width: 100%;
...
const AddTag = () => {
  ...
  return (
    <UpdateQnaTagInner>
      <UpdateQnaTagLabelBox>
        <UpdateQnaTagLabel htmlFor="hashtag">
          태그 <UpdateQnaPilsu>(필수)</UpdateQnaPilsu>
        </UpdateQnaTagLabel>
        <UpdateQnaTagLabelCount>{tagLength} / 35</UpdateQnaTagLabelCount>
      </UpdateQnaTagLabelBox>
      <UpdateQnaTagInsertBox
        onFocus={handleFocus}
        onBlur={handleBlur}
        isFocused={isFocused}
      >
        <UpdateQnaTagInsertIcon>#</UpdateQnaTagInsertIcon>
        <UpdateQnaTagInput
          id="hashtag"
          type="text"
