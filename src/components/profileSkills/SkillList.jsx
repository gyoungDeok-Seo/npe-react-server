    ...
    return (
        <CareerSkillModalSkillList>
            {popularSkills.map((item) => (
                <CareerSkillModalSkillBtn key={item} type="button" onClick={() => handleSkillClick(item)} selected={createSkills.skills.some((skill) => skill.skillName === item.skillName)}>
                    <CareerSkillModalSkillBtnText selected={createSkills.skills.some((skill) => skill.skillName === item.skillName)}>{item.skillName}</CareerSkillModalSkillBtnText>
