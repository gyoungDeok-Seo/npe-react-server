    ...
    return (
        <>
            {createSkills.skills.map((skill) => (
                <CareerSkillModalCraeteItem key={skill} type="button">
                    <CareerSkillModalCraeteItemText>{skill.skillName}</CareerSkillModalCraeteItemText>
                    <CareerSkillModalCraeteItemSvgBox role="presentation" onClick={() => handleSkillClick(skill)}>
