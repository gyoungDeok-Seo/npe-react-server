            ...
            <div>
                ...
                <div className="qna-container">
                    ...
                    <div className="qna-main-wrap">
                            ...
                            <div className="contents-header-box">
                                ...
                                <div className="contents-page-btn-box">
                                    <button type="button" className="prev-btn">
                                        <svg width="24" height="24" strokeWidth="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="prev-svg activation">
                                            <g>
                                                <g id="style=outline">
                        ...
                        <div className="best-answer-container"></div>
                        <section></section>
                        <h3></h3>
                        <Link></Link>
                    </div>
