...
function ProfileSkills() {
    ...
    const popularSkills = ["javascript", "React", "Github", "typescript", "css", "Java", "html", "Next.js", "MySQL", "python", "html5", "Node.js", "UI 디자인", "SpringBoot", "css3", "커뮤니케이션", "UX 디자인", "AWS", "Vue.js", "c언어", "Android", "React Query", "C++", "React Native", "Flutter", "c#", "Kotlin", "swift", "iOS", "Unity"];
                ...
                <div>
                    ...
                    <CareerSkillModalBox>
                        <CareerSkillModalContentBox>
                            ...
                            {selectedSkills.length !== 0 && (
                                <CareerSkillModalCraeteItemBox>
                                    <SelectSkillItem setSelectedSkills={setSelectedSkills} selectedSkills={selectedSkills} />
                                </CareerSkillModalCraeteItemBox>
                            )}
                            <CareerSkillModalContent>
                                <SkillSearchInput />
                                ...
                                <div>
                                    ...
                                    <SkillList setSelectedSkills={setSelectedSkills} selectedSkills={selectedSkills} />
                                </div>
                            </CareerSkillModalContent>
                        </CareerSkillModalContentBox>
                    </CareerSkillModalBox>
