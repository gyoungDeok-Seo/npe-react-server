                                ...
                                <div>
                                    <ProfileContentContainerInner>
                                        ...
                                        <ContentBox>
                                            <ContentTextBox>
                                                <div>
                                                    <ContentText>{isExistence ? "경력 ・ 2개월" : "경력"}</ContentText>
                                                </div>
                                                {isExistence && (
                                            ...
                                            {isExistence ? (
                                                <ContentList>
                                                    <ContentItem>
                                                        ...
                                                        <ContentContent>
                                                            <ContentContentName>테스트용 회사 - 프론트엔드 개발자</ContentContentName>
                                                            <ContentContentPeriod>2021.01 ~ 2021.02</ContentContentPeriod>
                                                            <div>
                                                                <ContentContentAnother>산업 분야: 여행</ContentContentAnother>
                                                            </div>
                                                            <div>
                                                                <ContentContentAnother>스킬: React, Github, typescript</ContentContentAnother>
                                                            </div>
                                                            <div>
                                                                <ContentContentAnother>테스트테스트테스트테스트테스트테스트테스트테스트테스트</ContentContentAnother>
                                                            </div>
