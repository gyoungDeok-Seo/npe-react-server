...
const tags = ["javascript", "react", "java", "spring", "python", "ai", "프론트엔드", "백엔드", "비전공자", "이직"];
...
function QnaMainContents() {
    ...
    const [topTenTransform, setTopTenTransform] = useState("translate3d(0px, 0px, 0px)");
    const [bestTransform, setBestTransform] = useState("translate3d(0px, 0px, 0px)");

    const [isTopTenDisabled, setIsTopTenDisabled] = useState({ prev: true, next: false });
    const [isBestDisabled, setIsBestDisabled] = useState({ prev: true, next: false });
        ...
        <QnaMainWrap>
            {tab === "newest" ? (
                <>
                    <TodayTopTenContainer>
                        <ContentsHeaderBox>
                            ...
                            <SlideButtonBox setTransform={setTopTenTransform} isDisabled={isTopTenDisabled} setIsDisabled={setIsTopTenDisabled} />
                        </ContentsHeaderBox>
                    ...
                    <BestAnswerContainer>
                        <ContentsHeaderBox>
                            ...
                            <SlideButtonBox setTransform={setBestTransform} isDisabled={isBestDisabled} setIsDisabled={setIsBestDisabled} />
                        </ContentsHeaderBox>
                ...
                <>
                        ...
                        {tag && (
                            <TagResetContainer>
                                ...
                                <TagResetBtn type="button" onClick={handleTagReset}>
                                    <TagResetSvg width="24" height="24" strokeWidth="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g id="style=outline">
                                                <path
                                                    id="Vector"
                    ...
                    <div>
                        <div style={{ height: "15851px", width: "100%", position: "relative" }}>
