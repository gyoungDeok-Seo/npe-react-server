...
export const createReplyApi = async (data) => {
  const response = await fetch("http://52.78.106.170:10000/replies/api/create", {
    method: "POST",
    credentials: "include",
    headers: {
      "Content-Type": "application/json",
...
export const updateReplyApi = async (data) => {
  const response = await fetch("http://52.78.106.170:10000/replies/api/update", {
    method: "POST",
    credentials: "include",
    headers: {
      "Content-Type": "application/json",
...
export const deleteReplyApi = async (data) => {
  const response = await fetch("http://52.78.106.170:10000/replies/api/delete", {
    method: "POST",
    credentials: "include",
    headers: {
      "Content-Type": "application/json",
...
export const sendReplyLikePeople = async (answerId) => {
  ...
  const response = await fetch("http://52.78.106.170:10000/replies/api/likeList", {
    method: "POST",
    credentials: "include",
    headers: {
      "Content-Type": "application/json",
...
export const replyLikeApi = async (data) => {
  const response = await fetch(
    "http://52.78.106.170:10000/replies/api/reply-like",
    {
      method: "POST",
      credentials: "include",
      headers: {
...
export const insertProfanityApi = async (comment, target) => {
  ...
  await fetch(`http://52.78.106.170:10000/replies/api/create-profanity`, {
    method: "POST",
    credentials: "include",
    headers: {
      "Content-Type": "application/json",
...
export const replyDeleteApi = async (data) => {
  await fetch(`http://52.78.106.170:10000/replies/api/hard-delete`, {
    method: "DELETE",
    credentials: "include",
    headers: {
      "Content-Type": "application/json",
